...
angular.module('ToDoApp', [])
    .config(function($httpProvider) {
        ...
        $httpProvider.defaults.headers.common['X-Parse-Application-Id'] = 'qIL0lbXY0Ra3AGhXTg9d2v2FXJh7XBbsAlkoa9Br';
        $httpProvider.defaults.headers.common['X-Parse-REST-API-Key'] = 'jRnlJjnRBn4TnAQRUgQrgsIGeqpd5F5pyDb2qcUM';
    })
